...
::: zone pivot="csharp"
<!-- TODO: section "note" missing for csharp -->
::: zone-end
...
:::image type="content" source="~/assets/diagrams/in-depth-guides-ai-a2a-overview.png" alt-text="Flowchart showing TeamsApp with A2APlugin receiving requests from an external A2A client" lightbox="~/assets/diagrams/in-depth-guides-ai-a2a-overview.png":::
