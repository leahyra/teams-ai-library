...
:::image type="content" source="~/assets/diagrams/why.png" alt-text="Flowchart showing Teams sending input events to your application and your application sending output events back" lightbox="~/assets/diagrams/why.png":::
...
:::image type="content" source="~/assets/diagrams/why-2.png" alt-text="Flowchart showing the message flow from Teams through a public facing endpoint to your application" lightbox="~/assets/diagrams/why-2.png":::
...
:::image type="content" source="~/assets/diagrams/why-3.png" alt-text="Diagram showing input event types being routed to corresponding application handlers" lightbox="~/assets/diagrams/why-3.png":::
...
:::image type="content" source="~/assets/diagrams/why-4.png" alt-text="Diagram showing user authentication with OAuth and SSO alongside input and output event authentication" lightbox="~/assets/diagrams/why-4.png":::
